...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train NPE on simglucose-generated SBI dataset")
    parser.add_argument(
        "--train-data",
        type=str,
        default=str(ROOT / "data" / "simglucose_sbi" / "train_data.pt"),
    )
    parser.add_argument(
        "--meta",
        type=str,
        default=str(ROOT / "data" / "simglucose_sbi" / "meta.pt"),
    )
    parser.add_argument(
        "--output-model",
        type=str,
